...
$(document).ready(function () {
  ...
  if ((window.location.pathname !== '{{ site.baseurl }}' && window.location.pathname !== '{{ site.baseurl }}index.html') || (window.location.href !== '{{site.github.url}}' && window.location.href !== '{{site.github.url}}/')) {
    $('.panel-cover').addClass('panel-cover--collapsed')
  }
